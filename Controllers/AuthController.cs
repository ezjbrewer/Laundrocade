...
using Laundrocade.Models.DTOs;
using Laundrocade.Data;

namespace Laundrocade.Controllers;
...
{
    private LaundrocadeDbContext _dbContext;
    private UserManager<IdentityUser> _userManager;

    public AuthController(LaundrocadeDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
